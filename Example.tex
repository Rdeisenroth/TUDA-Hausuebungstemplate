...
\begin{task}[points=auto,solution=true]{Alternativer style}
    ...
    \begin{subtask}[title={Irgend son Graph},points=2]
        ...
        \begin{solution}
            ...
            \ExplSyntaxOn
            %
            \tl_set_eq:NN \l_lel_tl \g__ptxcd_task_properties_loaded_tl
            % \rubos_prop_nested_get:nn {\l_lel_tl} {1,title}\par
            tl: \rubos_print_nested_tl:n {\l_lel_tl}\par
            \rubos_prop_nested_set:Nnn \l_lel_tl {4,credits,h,d,f} {9}
            tl: \rubos_print_nested_tl:n {\l_lel_tl}\par
            % \rubos_prop_nested_get:nn {\l_lel_tl} {1,title}\par
            % \rubos_prop_nested_set:Nnn \l_lel_tl {6} {3}
