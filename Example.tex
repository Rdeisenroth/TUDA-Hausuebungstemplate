...
\begin{task}[points=0]{Punktetabellen (WIP)}
    ...
    \begin{table}[ht]
        ...
        \begin{tabularx}{\textwidth}{|X|c|c|}
            ...
            \midrule\midrule
            \mapTasks*{%
            \textbf{\taskformat{}:~\getTaskTitle{\the\value{task}}}                & \getPoints{\thetask}                                 & \IfSubtasksTF{\mapSubtasks{ \\%
            \rowcolor{\thepagecolor}\thesubtask{}~\getSubTaskTitle{\the\value{task}}{\the\value{subtask}} & \getSubPoints{\the\value{task}}{\the\value{subtask}} &
                    }
            }{}                                                                                                                        \\
                \midrule\midrule
            }
