...
\begin{task}[points=auto,solution=true]{Alternativer style}
    ...
    \begin{subtask}[title={Irgend son Graph},points=2]
        ...
        \begin{solution}
            ...
            % \prg_generate_conditional_variant:Nnn \tl_if_in:nn { nn } { p }
            % \prg_set_conditional:Npnn \tl_if_in:nn #1#2 {p} {
            %     \exp_args:Nxx \tl_if_in:cnTF {#1} {#2} {\prg_return_true:} {\prg_return_false:}
            % }
            % \cs_show:N \tl_if_in_p:nn
            % \bool_if:nTF {\tl_if_in_p:nn {3={a)=3,b)=2,},4=2} {=} } {true} {false}
            % \bool_gset_true:N \rubos_tool_bool
            % \tl_if_in:NnF \g_rubos_basdiuhpiowehf_tl {=} {\bool_gset_false:N \rubos_tool_bool}
            % \bool_if:nT {\tl_if_empty_p:N \g_rubos_basdiuhpiowehf_tl || \tl_if_blank_p:n {\g_rubos_basdiuhpiowehf_tl}} {\bool_gset_true:N \rubos_tool_bool}
            % \bool_if:NTF \rubos_tool_bool {true}{false}
            % \bool_if:nTF {\__rubos_nested_contains_p:nn {3={a)=3,b)=2,},4=2}{3,c)}}{true}{false}
            % \bool_if:NTF \r_tuda_bruh_bool {true} {false}
            % \__rubos_is_prop_list:nTF {\g_rubos_basdiuhpiowehf_tl} {true} {false}
            %
            \rubos_prop_nested_set:nnn {3={a)=3,b)=2,},4=2}{3,c)} {8}
            \ExplSyntaxOff
        \end{solution}
    \end{subtask}
\end{task}
